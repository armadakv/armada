...
// Original package name kept for backward compatibility
...
type KVClient interface {
	...
	IterateRange(ctx context.Context, in *RangeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RangeResponse], error)
...
func (c *kVClient) IterateRange(ctx context.Context, in *RangeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RangeResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &KV_ServiceDesc.Streams[0], KV_IterateRange_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type KV_IterateRangeClient = grpc.ServerStreamingClient[RangeResponse]
...
type KVServer interface {
	...
	// IterateRange gets the keys in the range from the key-value store.
	IterateRange(*RangeRequest, grpc.ServerStreamingServer[RangeResponse]) error
	// Put puts the given key into the key-value store.
...
func (UnimplementedKVServer) IterateRange(*RangeRequest, grpc.ServerStreamingServer[RangeResponse]) error {
	return status.Error(codes.Unimplemented, "method IterateRange not implemented")
}
...
func _KV_IterateRange_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(KVServer).IterateRange(m, &grpc.GenericServerStream[RangeRequest, RangeResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type KV_IterateRangeServer = grpc.ServerStreamingServer[RangeResponse]
...
func (c *tablesClient) Create(ctx context.Context, in *CreateTableRequest, opts ...grpc.CallOption) (*CreateTableResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tables_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tablesClient) Delete(ctx context.Context, in *DeleteTableRequest, opts ...grpc.CallOption) (*DeleteTableResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tables_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tablesClient) List(ctx context.Context, in *ListTablesRequest, opts ...grpc.CallOption) (*ListTablesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tables_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedTablesServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedTablesServer) testEmbeddedByValue()                {}
...
func RegisterTablesServer(s grpc.ServiceRegistrar, srv TablesServer) {
	// If the following call panics, it indicates UnimplementedTablesServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
