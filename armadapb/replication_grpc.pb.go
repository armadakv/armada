...
const (
	...
	Snapshot_Query_FullMethodName  = "/replication.v1.Snapshot/Query"
)
...
func (c *snapshotClient) Query(ctx context.Context, in *SnapshotQueryRequest, opts ...grpc.CallOption) (*SnapshotQueryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SnapshotQueryResponse)
	err := c.cc.Invoke(ctx, Snapshot_Query_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSnapshotServer) Query(context.Context, *SnapshotQueryRequest) (*SnapshotQueryResponse, error) {
...
func _Snapshot_Query_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SnapshotQueryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SnapshotServer).Query(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Snapshot_Query_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SnapshotServer).Query(ctx, req.(*SnapshotQueryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Snapshot_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Query",
			Handler:    _Snapshot_Query_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
