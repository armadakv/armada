module github.com/armadakv/armada/integration

go 1.27.1

require (
	github.com/armadakv/armada v0.0.0
...
require (
	...
	github.com/armadakv/objfs v0.2.0 // indirect
...
// The harness drives the working tree, not a published release.
replace github.com/armadakv/armada => ../
