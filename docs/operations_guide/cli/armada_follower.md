...
```
  ...
  -h, --help                                           help for follower
      ...
      --replication.snapshot-source string             Snapshot object source: auto, direct, or proxy. direct uses shared-store backend from follower config; proxy uses leader HTTP endpoint. (default "auto")
