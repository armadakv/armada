...
description: "How to monitor ArmadaKV with Prometheus metrics and observe cluster health."
...
* `regatta_table_storage_cache_hits{clusterID="10001",table="armada-test",type="block"}` --
  Armada table storage block cache hits
