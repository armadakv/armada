...
for the complete gRPC API documentation for deleting records in Armada.

Delete Range API serves for deleting records in Armada, offering exact key-value pair deletion,
...
Armada then responds with the deleted key-value pairs, if any exists.
