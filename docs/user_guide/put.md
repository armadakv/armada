...
for the complete gRPC API documentation for inserting and updating records from Armada.

Put API serves for inserting and modifying records in Armada.
...
Additionally, the field `prev_kv` set to `true` can be supplied. Armada then responds with
