...
type MetricsServer struct {
	armadapb.UnimplementedMetricsServer
...
func (s *MetricsServer) GetMetrics(ctx context.Context, req *armadapb.MetricsRequest) (*armadapb.MetricsResponse, error) {
	if req.Format != "" {
	...
	return &armadapb.MetricsResponse{
