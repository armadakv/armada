...
const file_regatta_proto_rawDesc = "" +
	...
	"\x04List\x12\x1d.regatta.v1.ListTablesRequest\x1a\x1e.regatta.v1.ListTablesResponseBR\n" +
	"\tarmada.v1P\x01Z\v./regattapb\xa2\x02\x04AXV1\xaa\x02\tArmada.V1\xca\x02\tArmada\\V1\xe2\x02\tArmada\\V1\xea\x02\n" +
